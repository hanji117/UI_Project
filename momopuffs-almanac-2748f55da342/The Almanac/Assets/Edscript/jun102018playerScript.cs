...
using UnityEngine;
//I used the wrong script but this is the original PlayerLuna script. Darren Lile blender character to unity pt2.
public class jun102018playerScript : MonoBehaviour 
{
	...
	void Update () 
    {
        ...
        if (Input.GetKey(KeyCode.F) || Input.GetKeyDown("1") || Input.GetKeyDown("2"))
        { //if we press the F key, 1, or 2
